function listarProveedoresEnSelect() {
  fetch(
    "https://sistema-mgm-service-app-for-inventary.azurewebsites.net/api/proveedores/listado"
  )
...
function listarProductosEnSelect() {
  fetch(
    "https://sistema-mgm-service-app-for-inventary.azurewebsites.net/api/productos/listado"
  )
    .then((response) => response.json())
    .then((data) => {
...
function agregarEntrada(event) {
  ...
  if (
    !proveedorId === "Seleccione un proveedor" ||
    !productoId === "Seleccione un producto" ||
    !cantidad ||
    !fecha ||
    !costoUnitario
  ) {
  ...
  fetch(
    "https://sistema-mgm-service-app-for-inventary.azurewebsites.net/api/entradas/guardar",
    {
      method: "POST",
      headers: {
...
function listarInventario() {
  ...
  fetch(
    "https://sistema-mgm-service-app-for-inventary.azurewebsites.net/api/stock"
  )
    .then((response) => response.json())
    .then((data) => {
